...
Fundamentals: Syntax & Arithmetic Exercises
​Objective: Demonstrate mastery of basic Java output and mathematical operations. 
​Exercise 1: Console Output
• ​Description: A program to print student identity and major.
• ​Key Learning: Understanding System.out.println() for basic user feedback.
​
Exercise 2: Geometric Calculations
• ​Description: A program that calculates the Area (A) and Perimeter (P) of a rectangle.
• ​Logic: * Length (L) = 10, Width (W) = 5. 
• ​Area = L * W.
• ​Perimeter = 2 * (L + W). 
​Portfolio Summary
